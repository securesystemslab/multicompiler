...
void initializeGlobalRandomizationPass(PassRegistry&);
...
void initializeMarkVTablesPass(PassRegistry&);
void initializeMarkVTablesIRPass(PassRegistry&);
...
void initializePointerProtectionPass(PassRegistry&);
...
void initializeStackToHeapPromotionPass(PassRegistry&);
void initializeStackElementPaddingPass(PassRegistry&);
...
void initializeCookieSetterPass(PassRegistry&);
void initializeCookieProtectionPass(PassRegistry&);
}
