...
; RUN: llc < %s -mtriple=x86_64-linux -noop-insertion -rng-seed=25 | FileCheck %s --check-prefix=SEED2
; RUN: llc < %s -mtriple=x86_64-linux -noop-insertion -rng-seed=1534 | FileCheck %s --check-prefix=SEED3
